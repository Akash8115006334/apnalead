...
define("APP_LOGO_2", STORAGE_URL . "/company/img/logo/logo2.webp" . CONFIG("APP_LOGO_2"));
...
define("WORKING_DAYS_IN_MONTH", CONFIG("WORKING_DAYS_IN_MONTH"));
...
define("PAYROLL_REF_NO", "#PRN" . DATE('dmy') . "" . rand(000000, 999999));
