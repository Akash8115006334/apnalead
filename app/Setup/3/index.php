...
<body>
    ...
    <div class="container">
        ...
        <div class="row ">
            <div class="col-md-12 my-3 ">
                <p class="text-dark text-center">
                    Please ADD Your Company's Users
                </p>
            </div>
        </div>
                            ...
                            <form action="<?php echo CONTROLLER; ?>/ModuleHandler.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control form-control-sm" name="UserEmpGroupName">
                                            <?php
                                            $GetGroup = FETCH($GetGroupName, "UserEmpGroupName");
                                            echo '<option selected>' . $GetGroup . '</option>';
                                            CONFIG_VALUES("WORK_GROUP");
                                            ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
        ...
        <div class="col-md-12 text-center mt-4">
            <p class="text-dark my-3"><b>Note : </b>Welcome to ApnaLead! We're excited to have you on board. Our CRM is here to simplify your customer management and boost your productivity.</p>
            <a href="../../" class="btn btn-primary" id="finish-button">Finish</a>
            <a href="" class="btn btn-info text-light" id="finish-button">Upgrade Your Plan To Pro</a>
            <span id="userCountMessage"></span>
        </div>
    </div>

    <?php include $Dir . "assets/FooterFilesLoader.php"; ?>
    <script>
        let totalUserCount = <?php echo $TotalUserCount; ?>;
        let serialNumber = <?php echo $SerialNo; ?>;
        let mimuser = 3;
        ...
        window.onload = function() {
            document.getElementById('link3').classList.add('green');
        }

        //if user have free plan
