                      ...
                      <div class="">
                        ...
                        <form class="form row" action="<?php echo CONTROLLER; ?>/SystemController/ConfigController.php" method="POST">
                          ...
                          <div class="form-group form-group-2 col-md-12">
                            <label class="text-light">Mail Function</label>
                            <select name="CONTROL_MAILS" onchange="enablemails()" id="mailingstatus" class="form-control form-control-sm " required="">
                              <?php
                          ...
                          <div id="showemailoptions" class="row p-2" <?php echo $mailstatus; ?>>
                            <div class="form-group  col-md-12">
                              <label class="text-light" for="SENDER_MAIL_ID">Sender Mail-ID</label>
                              <input type="email" name="SENDER_MAIL_ID" value="<?php echo SENDER_MAIL_ID; ?>" class="form-control form-control-sm  w-100">
                            </div>
                            <div class="form-group form-group-2 col-md-12 w-100">
                              <label class="text-light" for="SENDER_MAIL_ID">Receiver Mail-ID</label>
                              <input type="email" name="RECEIVER_MAIL" value="<?php echo RECEIVER_MAIL; ?>" class="form-control form-control-sm  w-100">
                            </div>
                            <div class="form-group form-group-2 col-md-12 w-100">
                              <label class="text-light" for="SENDER_MAIL_ID">Customer Support Mail-ID</label>
                              <input type="email" name="SUPPORT_MAIL" value="<?php echo SUPPORT_MAIL; ?>" class="form-control form-control-sm  w-100">
                            </div>
                            <div class="form-group form-group-2 col-md-12 w-100">
                              <label class="text-light" for="SENDER_MAIL_ID">Enquiry Mail-ID</label>
                              <input type="email" name="ENQUIRY_MAIL" value="<?php echo ENQUIRY_MAIL; ?>" class="form-control form-control-sm  w-100">
                            </div>
                            <div class="form-group form-group-2 col-md-12 w-100">
                              <label class="text-light" for="SENDER_MAIL_ID">Admin Mail-ID</label>
                              <input type="email" name="ADMIN_MAIL" value="<?php echo ADMIN_MAIL; ?>" class="form-control form-control-sm  w-100">
                            </div>
                          </div>
                      ...
                      <div class="">
                        ...
                        <form action="" method="GET" class="row form">
                          <div class="form-group form-group col-md-12">
                            <label class="text-light">Select Payment Gateway Provider</label>
                            <select name="PG_PROVIDER" class="form-control form-control-sm " required="" onchange="form.submit()">
                        ...
                        <form class="form row" action="<?php echo CONTROLLER; ?>/SystemController/ConfigController.php" method="POST">
                          ...
                          <?php FormPrimaryInputs(true); ?>
                          <div class="form-group form-group-2 col-md-12">
                            <label class="text-light">Enable/Disable Online Payments</label>
                            <select name="ONLINE_PAYMENT_OPTION" onchange="enablepaymentgateway()" id="pgstatus" class="form-control form-control-sm " required="">
                              <?php
                          ...
                          <div id="pgoptions" <?php echo $pgstatus; ?>>
                            <div class="form-group form-group-2 col-md-12">
                              <label class="text-light" for="PG_MODE">PG Mode <small><i class="fa fa-angle-right"></i> eg: prod, test, dev, live</small></label>
                              <input type="text" name="PG_MODE" value="<?php echo $PG_MODE; ?>" class="form-control form-control-sm  text-uppercase">
                            </div>
                            <div class="form-group form-group-2 col-md-12">
                              <label class="text-light" for="MERCHENT_ID">Merchant ID</label>
                              <input type="text" name="MERCHENT_ID" value="<?php echo $MERCHENT_ID; ?>" class="form-control form-control-sm ">
                            </div>
                            <div class="form-group form-group-2 col-md-12">
                              <label class="text-light" for="MERCHANT_KEY">Merchant Key</label>
                              <input type="text" name="MERCHANT_KEY" value="<?php echo $MERCHANT_KEY; ?>" class="form-control form-control-sm ">
                            </div>
                          </div>
                          <div class="col-md-12 m-t-10">
                      ...
                      <div class="">
                        ...
                        <form class="form row" action="<?php echo CONTROLLER; ?>/SystemController/ConfigController.php" method="POST">
                          ...
                          <div class="form-group form-group-2 col-md-7">
                            ...
                            <input type="number" name="CONTROL_MSG_DISPLAY_TIME" class="form-control form-control-sm " required="" value="<?php echo CONTROL_MSG_DISPLAY_TIME; ?>">
                          </div>
                          <div class="form-group form-group-2 col-md-5">
                            <label>Listing Limit</label>
                            <input type="number" name="DEFAULT_RECORD_LISTING" class="form-control form-control-sm " required="" value="<?php echo DEFAULT_RECORD_LISTING; ?>">
                          </div>
                          <div class="form-group form-group-2 col-md-12">
