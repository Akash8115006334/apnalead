                ...
                <?php if (isset($_GET['token'])) {
                    ...
                    if ($CurrentDateTime <= $PasswordChangeTokenExpireTime) {
                        if ($RequiredToken == $ReceivedToken) { ?>
                            <form role="form" action="../../../controller/authcontroller.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="Password1" value="" id="Pass1" required="" class="form-control form-control-sm outline-danger">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="inputUsernameEmail">Re-Enter New Password</label>
                                    <input type="password" name="Password2" id="Pass2" value="" required="" class="form-control form-control-sm" oninput="CheckPassMatch()">
                                </div>
                                <br>
                        ...
                        <?php } else {
                            ...
                            UPDATE_TABLE("user_password_change_requests", $UpdateTable, "PasswordChangeToken='$PasswordChangeToken' and UserIdForPasswordChange='$UserIdForPasswordChange'");
                        ?>
                        ...
                        <p class="text-center mb-3">Received Password change token is not valid or may be epxired. You have to create new one by following below links.</p>
                        <div class="flex-s-b">
                            <a href="<?php echo DOMAIN; ?>/auth/login" class="text-info"><i class="fa fa-angle-left"></i> Back to Login</a>
                            <a href="<?php echo DOMAIN; ?>/auth/forget/" class="text-info">Password Reset <i class='fa fa-angle-right'></i></a>
                        </div>
                    <?php }
                } else { ?>
                    <h5><b>Ooopsss......</b></h5>
