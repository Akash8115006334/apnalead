...
if (isset($_POST['UpdatePrimaryConfigurations'])) {
  ...
  $Update = UPDATE_TABLE("config_pgs", $config_pgs, "ConfigPgProvider='$ConfigPgProvider'");
  ...
  $APP_LOGO = UPLOAD_FILES("../../storage/company/img/logo", "", APP_NAME . "", "APP_LOGO");
  ...
  $Update = UPDATE_TABLE("config_values", $data, "ConfigValueId='$ConfigValueId'");
  ...
  $config_locations = [
    ...
    "config_location_created_by" => AuthAppUser("UserId"),
    "config_location_updated_by" => AuthAppUser("UserId")
  ];
  ...
  $Response = UPDATE_TABLE("config_locations", $config_locations, "config_location_id='$config_location_id'");
  RequestHandler($Response, [
